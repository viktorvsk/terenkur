...
sitemap :site do
  ...
  url page_url(:parnters), last_mod: Time.now, change_freq: "monthly", priority: 0.9
  url page_url(:about), last_mod: Time.now, change_freq: "monthly", priority: 0.9
  url users_url, last_mod: User.order('updated_at DESC').first.updated_at
